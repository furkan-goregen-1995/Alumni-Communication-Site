...
<div class="col-md-4 col-sm-offset-4 col-sm-6 col-sm-offset-5 col-xs-10 col-xs-offset-1">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <select class="form-control" required="" name="profil_sehir">
  <?php include 'iller.php'; ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                   <input type="checkbox" required="" name="profil_dil[]" value="C#" id="dil">C#<br>
...
<input type="checkbox"  id="dil" name="profil_dil[]" value="V.B">V.B<br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <select required="" class="form-control" name="profil_uni">
